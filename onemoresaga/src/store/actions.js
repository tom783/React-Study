...
export const GET_MOVIE_PENDING = "actions/GET_MOVIE_PENDING";
...
export const GET_NEWS_PENDING = "actions/GET_NEWS_PENDING";
...
export const GET_PLACE_PENDING = "actions/GET_PLACE_PENDING";
...
export const getMoviePend = createAction(GET_MOVIE_PENDING);
...
export const getNewsPend = createAction(GET_NEWS_PENDING);
...
export const getPlacePend = createAction(GET_PLACE_PENDING);
